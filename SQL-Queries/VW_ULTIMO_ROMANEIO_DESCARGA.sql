...
FROM (
	...
	ROW_NUMBER() OVER (PARTITION BY CON.CODCON, CON.CODFIL, CON.SERCON, IRD.NOTFIS, RMD.CODRMD ORDER BY RMD.DATREF DESC) AS DATA_ORDER
	FROM RODCON CON
	...
	WHERE RMD.CODFIL=10 AND IRD.TIPDOC='C' AND RMD.DATREF>='2021-01-01'
) DOCS
WHERE DATA_ORDER<=1
...
FROM (
	...
	INNER JOIN RODCLI CLI ON CON.CODPAG=CLI.CODCLIFOR
	INNER JOIN RODSEG SEG ON CON.CODSEG=SEG.CODSEG
	WHERE RMD.CODFIL=5 AND IRD.TIPDOC='C' AND RMD.DATREF>='2021-01-01'
) DOCS
WHERE DATA_ORDER<=1
...
FROM (
	...
	INNER JOIN RODCLI CLI ON CON.CODPAG=CLI.CODCLIFOR
	INNER JOIN RODSEG SEG ON CON.CODSEG=SEG.CODSEG
	WHERE RMD.CODFIL=11 AND IRD.TIPDOC='C' AND RMD.DATREF>='2021-01-01'
) DOCS
WHERE DATA_ORDER<=1
...
FROM (
	...
	ROW_NUMBER() OVER (PARTITION BY ORD.CODIGO, ORD.CODFIL, ORD.SERORD, IRD.NOTFIS, RMD.CODRMD ORDER BY RMD.DATREF DESC) AS DATA_ORDER
	FROM RODORD ORD
	...
	WHERE RMD.CODFIL=10 AND IRD.TIPDOC='O' AND RMD.DATREF>='2021-01-01'
) DOCS
WHERE DATA_ORDER<=1
...
FROM (
	...
	INNER JOIN RODCLI CLI ON ORD.CODPAG=CLI.CODCLIFOR
	INNER JOIN RODSEG SEG ON ORD.CODSEG=SEG.CODSEG
	WHERE RMD.CODFIL=5 AND IRD.TIPDOC='O' AND RMD.DATREF>='2021-01-01'
) DOCS
WHERE DATA_ORDER<=1
...
FROM (
	...
	INNER JOIN RODCLI CLI ON ORD.CODPAG=CLI.CODCLIFOR
	INNER JOIN RODSEG SEG ON ORD.CODSEG=SEG.CODSEG
	WHERE RMD.CODFIL=11 AND IRD.TIPDOC='O' AND RMD.DATREF>='2021-01-01'
) DOCS
WHERE DATA_ORDER<=1